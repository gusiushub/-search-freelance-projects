...
//
//
//$grups = array ('-3183750'); #ID Группы откуда будут постить записили
//$randomm = mt_rand (0, count($grups)-1);
//$grup = $grups[$randomm]; #Рандом групп
//
//$robber->SetVar("token", "37bb8183e7e48e543f95a3234442f0fdef6d9cf4847a393d3496bfa4be32d977458622ce2f6d08d397bfa"); #токен от андройд
